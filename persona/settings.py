...
SECRET_KEY = "django-insecure-lf0k_u4za2j99_9^qmapi*pgxl29-aqat6c5c^f^yvgy(t7oo("
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'ssl': {
                'ca': '/Users/Adwait/Desktop/persona/certificates/ca.cer',  # Path to the CA certificate provided by Aiven
            }
        }
    }
}
